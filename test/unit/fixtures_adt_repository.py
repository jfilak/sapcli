...
PACKAGE_ENVELOPE_NODESTRUCTURE_XML = '''<?xml version="1.0" encoding="UTF-8"?><asx:abap xmlns:asx="http://www.sap.com/abapxml" version="1.0">
  <asx:values>
    <DATA>
      <TREE_CONTENT>
        <SEU_ADT_REPOSITORY_OBJ_NODE>
...
PACKAGE_ENVELOPE_NODESTRUCTURE_OK_RESPONSE = Response(status_code=200, text=PACKAGE_ENVELOPE_NODESTRUCTURE_XML, headers={
    'Content-Type': 'application/vnd.sap.as+xml; charset=utf-8; dataname=com.sap.adt.RepositoryObjectTreeContent'})

PACKAGE_WITHOUT_SUBPKG_NODESTRUCTURE_XML = '''<?xml version="1.0" encoding="UTF-8"?><asx:abap xmlns:asx="http://www.sap.com/abapxml" version="1.0">
  <asx:values>
    <DATA>
      <TREE_CONTENT/>
      <CATEGORIES>
...
PACKAGE_WITHOUT_SUBPKG_NODESTRUCTURE_OK_RESPONSE = Response(status_code=200, text=PACKAGE_WITHOUT_SUBPKG_NODESTRUCTURE_XML, headers={
    'Content-Type': 'application/vnd.sap.as+xml; charset=utf-8; dataname=com.sap.adt.RepositoryObjectTreeContent'})
