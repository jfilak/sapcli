...
class TestgCTSRepoMessages(PatcherTestCase, ConsoleOutputTestCase):
    ...
    def setUp(self):
        ...
        self.expected_json_process = sap.cli.core.json_dumps(self.process_data)
        # Note: trailing spaces match column padding from TableWriter
