...
"""
    ...
    def test_aunit_junit4aunit_no_test_methods(self):
        self.connection.set_responses(Response(status_code=200, text=AUNIT_RESULTS_NO_TEST_METHODS_XML, headers={}))

        with patch('sap.cli.core.get_console', return_value=BufferConsole()) as mock_stdout:
            self.execute_run('package', 'ypackage', '--output', 'junit4aunit', '--result', ResultOptions.ONLY_UNIT.value)
...
''')
    ...
    def test_aunit_package_with_results_junit4aunit(self):
        self.connection.set_responses(Response(status_code=200, text=AUNIT_RESULTS_XML, headers={}))

        with patch('sap.cli.core.get_console', return_value=BufferConsole()) as mock_stdout:
            exit_code = self.execute_run('package', 'ypackage', '--output', 'junit4aunit', '--result', ResultOptions.ONLY_UNIT.value)
...
<testsuites name="ypackage">
  <testsuite name="LTCL_TEST" package="ZCL_THEKING_MANUAL_HARDCORE" tests="3">
    <testcase name="DO_THE_FAIL" classname="LTCL_TEST" status="ERR">
      <failure type="failedAssertion" message="Critical Assertion Error: 'I am supposed to fail'">Include: &lt;ZCL_THEKING_MANUAL_HARDCORE===CCAU&gt; Line: &lt;19&gt; (DO_THE_FAIL)</failure>
      <system-out>True expected
Test 'LTCL_TEST-&gt;DO_THE_FAIL' in Main Program 'ZCL_THEKING_MANUAL_HARDCORE===CP'.</system-out>
    </testcase>
    <testcase name="DO_THE_WARN" classname="LTCL_TEST" status="SKIP">
      <failure type="failedAssertion" message="Warning: 'I am supposed to warn'">Include: &lt;ZCL_THEKING_MANUAL_HARDCORE===CCAU&gt; Line: &lt;19&gt; (DO_THE_WARN)</failure>
      <system-out>True expected
Test 'LTCL_TEST-&gt;DO_THE_WARN' in Main Program 'ZCL_THEKING_MANUAL_HARDCORE===CP'.</system-out>
    </testcase>
  ...
  <testsuite name="LTCL_TEST_HARDER" package="ZCL_THEKING_MANUAL_HARDCORE" tests="2">
    <testcase name="DO_THE_FAIL" classname="LTCL_TEST_HARDER" status="ERR">
      <failure type="failedAssertion" message="Critical Assertion Error: 'I am supposed to fail'">Include: &lt;ZCL_THEKING_MANUAL_HARDCORE===CCAU&gt; Line: &lt;19&gt; (DO_THE_FAIL)</failure>
      <system-out>True expected
Test 'LTCL_TEST_HARDER-&gt;DO_THE_FAIL' in Main Program 'ZCL_THEKING_MANUAL_HARDCORE===CP'.</system-out>
    </testcase>
    <testcase name="DO_THE_TEST" classname="LTCL_TEST_HARDER" status="OK"/>
  </testsuite>
  <testsuite name="LTCL_TEST" package="ZEXAMPLE_TESTS" tests="2">
    <testcase name="DO_THE_FAIL" classname="LTCL_TEST" status="ERR">
      <failure type="failedAssertion" message="Critical Assertion Error: 'I am supposed to fail'">Include: &lt;ZEXAMPLE_TESTS&gt; Line: &lt;24&gt; (DO_THE_FAIL)
Include: &lt;ZEXAMPLE_TESTS&gt; Line: &lt;25&gt; (PREPARE_THE_FAIL)</failure>
      <system-out>True expected
Test 'LTCL_TEST-&gt;DO_THE_FAIL' in Main Program 'ZEXAMPLE_TESTS'.</system-out>
...
'''''')
    ...
    def test_aunit_class_junit4aunit_syntax_error(self):
        self.connection.set_responses(Response(status_code=200, text=AUNIT_SYNTAX_ERROR_XML, headers={}))

        with patch('sap.cli.core.get_console', return_value=BufferConsole()) as mock_print:
            retval = self.execute_run('class', 'yclass', '--output', 'junit4aunit', '--result', ResultOptions.ONLY_UNIT.value)
...
''')
    ...
    def test_aunit_parser_results_global_class_tests_junit4aunit(self):
        results = sap.adt.aunit.parse_aunit_response(GLOBAL_TEST_CLASS_AUNIT_RESULTS_XML).run_results
        output = BufferConsole()
        sap.cli.aunit.print_aunit_junit4aunit(results, SimpleNamespace(name=['$TMP']), output)
...
<testsuites name="$TMP">
  <testsuite name="ZCL_TEST_CLASS" package="ZCL_TEST_CLASS" tests="1">
    <testcase name="ZCL_TEST_CLASS" classname="ZCL_TEST_CLASS" status="SKIP">
      <error type="warning" message="The global test class [ZCL_TEST_CLASS] is not abstract"/>
      <system-out>You can find further informations in document &lt;CHAP&gt; &lt;SAUNIT_TEST_CL_POOL&gt;</system-out>
    </testcase>
    <testcase name="DO_THE_TEST" classname="ZCL_TEST_CLASS" status="OK"/>
  </testsuite>
</testsuites>
...
''')
    ...
    def test_aunit_parser_results_global_class_tests_multiple_targets_junit4aunit(self):
        results = sap.adt.aunit.parse_aunit_response(GLOBAL_TEST_CLASS_AUNIT_RESULTS_XML)
        output = BufferConsole()
        sap.cli.aunit.print_aunit_junit4aunit(results.run_results, SimpleNamespace(name=['$TMP', '$LOCAL', '$BAR']), output)
...
''')
    ...
    def test_aunit_parser_results_test_class_with_sys_error_followed_by_green_test_class_junit4aunit(self):
        results = sap.adt.aunit.parse_aunit_response(TEST_CLASS_WITH_SYS_ERROR_FOLLOWED_BY_GREEN_TEST_CLASS_AUNIT_RESULTS_XML).run_results
        output = BufferConsole()
        sap.cli.aunit.print_aunit_junit4aunit(results, SimpleNamespace(name=['$TMP']), output)
...
<testsuites name="$TMP">
  ...
  <testsuite name="ZCL_TEST_CLASS" package="ZCL_TEST_CLASS" tests="0">
    <testcase name="ZCL_TEST_CLASS" classname="ZCL_TEST_CLASS" status="ERR">
      <failure type="failedAssertion" message="The global test class [ZCL_TEST_CLASS] is not abstract">Include: &lt;ZCL_TEST_CLASS=======CM010&gt; Line: &lt;1&gt;</failure>
      <system-out>Some detail text</system-out>
    </testcase>
  </testsuite>
</testsuites>
''')
