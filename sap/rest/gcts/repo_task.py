...
class RepositoryTask:
    ...
    def __init__(self, connection, rid, data: Optional[dict] = None):
        if not rid:
    ...
    def to_dict(self):
        """Convert task data to dictionary including rid."""
    ...
    @property
    def createdBy(self):
        """Get task creator's ABAP user login."""
    ...
    @property
    def changedBy(self):
        """Get last modifier's ABAP user login."""
    ...
    def create(self, task_definition: 'RepositoryTask.TaskDefinition', parameters: Optional['RepositoryTask.TaskParameters'] = None):
        """Create task
